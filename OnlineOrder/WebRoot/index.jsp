			...
			<div class="container">
				...
				<div class="row content">
					...
					<div class="col-md-9">
						...
						<ul class="feature">
							<h3><i class="arrow"> </i><span>流行菜品</span></h3>
						</ul>
...
<!-- 流行菜 -->						
						...
						<ul class="dc_pagination dc_paginationA dc_paginationA06">
							<li>
								<a href="index?pageNo=${pb.firstPage }">首页</a>
							</li>
							<li>
								<a href="index?pageNo=${pb.upPage }">上一页</a>
							</li>
							<li>
								<a href="index?pageNo=${pb.downPage }">下一页</a>
							</li>
							<li>
								<a href="index?pageNo=${pb.lastPage }">末页</a>
							</li>
							<li>
								总共${pb.totalRows }条记录,共${pb.totalPage }页，当前第${pb.pageNo }页
							</li>
						</ul>
					</div>
				</div>
