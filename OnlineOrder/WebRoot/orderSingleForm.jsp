...
<!-- 登录按钮 -->
		...
		<div class="main">
			<div class="container">
				...
				<div class="orderForm">
					<form method="post" action="ordersingleform">
						<table >
							<tr>
								<td colspan="3">
							...
							<tr>
								...
								<td colspan="3">${singleCate.cate_name }</td>
								<td colspan="2"></td>
							</tr>
							<tr>
								<td>
								...
								<td colspan="2">
									<input type="text" name="address" class="text" value="${loginer.address }" >
								</td>
							</tr>
							<tr>
								<td>
								...
								<td colspan="2">
									<input type="text" name="phone" class="text" value="${loginer.mobile }" >
								</td>
							</tr>
							<tr>
								<td height="40px">
							...
							<tr>
								...
								<td colspan="2"><textarea name="words" rows="" cols="" >无</textarea></td>
							</tr>
						</table>
