...
<!-- 模糊查询 -->
						<form method="post" action="productformmohu">
							高级查询 &nbsp; &nbsp; 
							商品编号:<input type="text" name="in1" value="${pojo.cate_id1 }"/>—
							<input type="text" name="in2" value="${pojo.cate_id2 }"/> 
							商品名:<input type="text" name="in3" value="${pojo.cate_name }"/>
							商品价格:<input type="text" name="${pojo.price }"/>
...
<!-- 商品状态 -->
    				...
    				<h3>
    					<a href="productform?pageNo=${pb.firstPage }&str=all">首页</a><a href="productform?pageNo=${pb.upPage }&str=all">上一页</a>
    					<a href="productform?pageNo=${pb.downPage }&str=all">下一页</a>
    					<a href="productform?pageNo=${pb.lastPage }&str=all">末页</a>
    				</h3>
				</div>
			</div>
		</div>
