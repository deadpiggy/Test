...
@WebServlet( name="dropshoppingcarServlet", urlPatterns="/dropshoppingcar" )
public class DropSCServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		boolean flag = dao.dropSC( user.getUser_id() );
